...
from simple_gru import CartPolePolicy, PendulumPolicy
...
def save_results(pendulum_params, cartpole_params, pendulum_history, cartpole_history, 
    ...
    print(f"  - pendulum_best_params{filename_suffix}.npy")
    print(f"  - cartpole_best_params{filename_suffix}.npy")
    print(f"  - evolution_history{filename_suffix}.pkl")
