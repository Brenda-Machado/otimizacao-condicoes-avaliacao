...
This implementation uses GRU (Gated Recurrent Unit) for control tasks such as 
inverted pendulum and cartpole. GRUs are simpler than LSTMs but provide superior
performance for neuroevolution tasks with continuous control, as demonstrated
by Pagliuca et al. (2020).
